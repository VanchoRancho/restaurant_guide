            ...
            <div class="list_food">
                ...
                <div class="item dib">
                    <div class="float_item">
                        ...
                        <p>Каи хотатэ 105 г</p>
                        <p>С креветкой, копченой курицей, кунжутом, рукколой, огурцом и соусом «Унаги», 4 шт.</p>
                        <p class="color_dark price">285 x <span>1</span> = <span>285</span></p>
                        <form>
                    ...
                    <p>Каи хотатэ 105 г</p>
                    <p class="color_dark price">285 руб.</p>
                    <form>
                        <span class="minus dib">-</span>
                        <input type="text" class="input_count dib" value="20">
                        <span class="plus dib">+</span>
                ...
                <div class="item dib">
                    <div class="float_item">
                        ...
                        <p>С креветкой, копченой курицей, кунжутом, рукколой, огурцом и соусом «Унаги», 4 шт.</p>
                        <p class="color_dark price">285 x <span>1285</span> = <span>285</span></p>
                        <form>
                            <span class="minus dib">-</span>
                            <input type="text" class="input_count dib" value="1">
                            <span class="plus dib">+</span>

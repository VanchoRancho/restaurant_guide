<?php include_once 'header.inc.php';?>
    ...
    <div class="page_rest item_article">
        ...
        <div class="back_to_parent"><a href="02_catalog_by_list.php" class="color_dark"><img src="img/arrow_gray_left.svg" alt="" class="dibm">Обратно в Новости</a></div>

        <h2>Вкусно, полезно, увлекательно</h2>
        <p>Петербургское лето захватывает, что уж тут говорить, но при любой погоде, наши гости — в отличном настроении! И, в немалой степени, на это влияют вкусные трапезы. А провести их у нас можно необычно, заказав, например, блюда на вулканических камнях, разогретых до 400 градусов! Да-да, такое бывает, и это нужно попробовать!</p>
        <p>Вы сами участвуете в процессе приготовления, просто переворачивая аппетитные кусочки мяса или морепродуктов и прожаривая их так, как нравится вам! Процесс приготовления занимает от 2 до 15 мин. Блюда готовятся без масла и жира, в собственном соку и приобретают, при этом, неповторимый вкус!</p>

        <div class="images">
            <img src="img/content/05_restaurant_news/restaurant_news_03.jpg">
        </div>

        <p class="date color_dark">20 августа, 20:00</p>

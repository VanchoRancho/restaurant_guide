<?php include_once 'header.inc.php';?>
    ...
    <div class="cols list_articles">
        <div class="col-2 dib item">
            ...
            <p><a href="#" class="color_dark">Горнолыжный комплекс «Золотая Долина»</a></p>
        </div>
        ...
        <div class="col-2 dib item">
            ...
            <p><a href="#" class="color_dark">Ресторан «Пьяная гавань»</a></p>
        </div>
        ...
        <div class="col-2 dib item">
            ...
            <p><i class="color_dark">25 августа</i> 20:10 ч</p>
            <p><a href="#" class="color_dark">Ресторан «On My Roof»</a></p>
        </div>

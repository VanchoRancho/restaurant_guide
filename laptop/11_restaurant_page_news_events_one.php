<?php include_once 'header.inc.php';?>
    ...
    <div class="page_rest item_article">
        ...
        <div class="back_to_parent"><a href="02_catalog_by_list.php" class="color_dark"><img src="img/arrow_gray_left.svg" alt="" class="dibm">Обратно к Событиям</a></div>

        <p class="name_category">Трансляции</p>
        <h2>Спортивные онлайн трансляции</h2>
        <p>Дорогие друзья! Будем рады видеть Вас на прямых трансляциях с Олимпиады в РИО, Чемпионата России по футболу, хоккейного предсезонного турнира в Сочи «Sochi Hockey Open» и другим видам спорта на уютной террасе ресторана «Любимый», чтобы поболеть за любимых спортсменов. Захватывающие баталии демонстрируются на экранах террасы ежедневно, с 12.00! Во время поздних трансляций ресторан работает до окончания матчей.</p>
        <p>Шашлыки, пиццы, домашние колбаски и множество других блюд европейской, восточной, паназиатской, узбекской кухни, а также широкий выбор напитков и десертов «ЛюбимREST», безусловно, помогут вам «болеть» изо всех сил!</p>
        <p>Ежедневно с 12:00 до 00:00</p>
        <div class="images">
            <img src="img/content/05_restaurant_news/restaurant_news_02.jpg">
        </div>

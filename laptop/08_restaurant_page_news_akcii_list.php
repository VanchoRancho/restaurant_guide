<?php include_once 'header.inc.php';?>
    ...
    <div class="page_rest">
        ...
        <div class="share_list">
            <div class="item">
                <p class="color_middle">Скидка</p>
                <p><a href="09_restaurant_page_news_akcii_one.php" class="color_dark">Подарки на сумму до 10 000 руб.</a></p>
                <p>Мы дарим маленьким именинникам 15-процентную скидку, чтобы запечатлеть прекрасные мгновения праздника.</p>
            </div>

            <div class="item">
                <p class="color_middle">Подарок</p>
                <p><a href="09_restaurant_page_news_akcii_one.php" class="color_dark">Вино в подарок</a></p>
                <p>Бокал красного или белого домашнего вина каждому гостю в качестве комплимента в будние дни после 17:00.</p>
            </div>
        </div>


        <a href="#" class="link_more color_dark"><img src="img/plus_yellow_small.svg" class="dibm">Все акции</a>
    </div>
